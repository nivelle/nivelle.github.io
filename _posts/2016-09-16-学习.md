...
###  创建ServerSocketChannel 并设置相应参数

###  创建Selector 并注册到ServerSocketChannel 上

###  调用Selecto的select方法等待请求

###  selector接收到请求后使用selectKeys返回SelectionKey集合

###  使用selectionkey 获取到channel、selector 和操作类型并进行具体操作。
